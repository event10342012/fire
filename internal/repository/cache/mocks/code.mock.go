...
func (m *MockCodeCache) Get(ctx context.Context, biz, phone string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCodeCacheMockRecorder) Get(ctx, biz, phone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCodeCache)(nil).Get), ctx, biz, phone)
}
