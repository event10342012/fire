...
func (m *MockArticleRepository) Publish(ctx context.Context, art domain.Article) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleRepositoryMockRecorder) Publish(ctx, art any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockArticleRepository)(nil).Publish), ctx, art)
}
